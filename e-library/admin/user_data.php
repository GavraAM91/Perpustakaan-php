  ...
  <table class="table table-striped table-hover table-bordered" border=1>
    ...
    ?>
      <tr>
        ...
        <td>
          <!-- <div class="option">
            <a href="delete_user.php?id=<?= $row['id_user'] ?>"><button type="button" class="btn btn-danger">Delete</button></a>
            <a href="edit_user.php?id=<?= $row['id_user'] ?>"><button type="button" class="btn btn-warning">Edit</button></a>
          </div> -->
        </td>
      </tr>
    <?php } ?>
