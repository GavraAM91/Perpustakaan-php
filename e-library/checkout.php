...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO `order`(`id`,`image`,`book_name`,`quantity`,`name`,`phone_number`, `email`, `street`, `city`,`random_code`) 
    VALUES ('','$image','$book_name','$quantity','$name','$phone_number','$email','$street','$city','$random_code')";
    ...
    <div class="container">
        ...
        <section class="checkout-form">
            ...
            <form action="" method="post">
                ...
                <div class="flex">
                    <input type="hidden" value="<?php echo $image; ?>" name="image" required>
